...
var $, $$, Game, ItemDom, ItemState, Obfuscator, UpgradeDom, UpgradeState, add_commas, convert_save, deobf, format_number, ob_v1, obf, product, sum, u_mod,
...
ItemDom = (function() {
  ...
  ItemDom.prototype.update = function() {
    var o;
    this.button_text = "Buy" + (key.shift ? " 10" : "\xa0\xa0\xa0") + "\xa0\xa0\xa0\xa0" + (format_number(this.item.calc_price_s()));
...
ItemState = (function() {
  ...
  ItemState.prototype.calc_price_s = function() {
    if (key.shift) {
...
Game = (function() {
  ...
  function Game() {
    ...
    key('shift', ((function(_this) {
      return function() {
        return _this.update_doms();
      };
    })(this)), ((function(_this) {
      return function() {
        _this.update_doms();
    ...
    $$('#export button').addEventListener('click', (function(_this) {
      return function() {
        prompt('Save this somewhere safe', _this.save());
        return _this.close_settings();
      };
    })(this));
  ...
  Game.prototype.update_doms = function() {
    var i, l, len, ref, results;
    ref = this.items;
    results = [];
    for (l = 0, len = ref.length; l < len; l++) {
      i = ref[l];
      results.push(i.dom.update());
    }
    return results;
  };
  ...
  Game.prototype._load = function(save) {
    var i, l, len, ref, t, v;
    clearTimeout(this.last_interval);
    if (save[''] === 123) {
      this.dev = true;
...
document.addEventListener('DOMContentLoaded', function() {
  var ch, fn, game, i, l, len, q, toggles, x;
  game = new Game();
