...
var $, $$, Game, ItemDom, ItemState, UpgradeDom, UpgradeState, a, add_commas, convert_save, deobf, format_number, i, l, ob, obf, product, ref, sum, u_mod,
...
for (i = l = 0, ref = ob.a.length; 0 <= ref ? l < ref : l > ref; i = 0 <= ref ? ++l : --l) {
  ob.f[ob.a[i]] = i;
  ob.r[ob.b[i]] = i;
}
...
Game = (function() {
  function Game() {
    ...
    $$('#export button').addEventListener('click', (function(_this) {
      return function() {
        prompt('Save this somewhere safe', obf(JSON.stringify(_this.save())));
        return _this.close_settings();
      };
    })(this));
  ...
  Game.prototype.load = function(save) {
    ...
    t = true;
    for (i = m = 0, len = order.length; m < len; i = ++m) {
      v = order[i];
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  fn = function(q, i) {
    return i.addEventListener('click', function() {
      ...
      q.style.display = "";
      for (w = 0, len2 = ch.length; w < len2; w++) {
        j = ch[w];
        if (j !== i) {
