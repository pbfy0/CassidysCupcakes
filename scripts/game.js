...
(function() {
  var $, $$, Game, ItemDom, ItemState, Obfuscator, UpgradeDom, UpgradeState, a_format_number, add_commas, e, format_number, g_format_number, g_settings, g_shift, has_localstorage, ob_v1, product, sum, u_mod,
    indexOf = [].indexOf;
  ...
  (function() {
    var _settings, ref, ss;
    ss = has_localstorage ? (ref = localStorage.getItem('ccSettings')) != null ? ref : '{}' : '{}';
    g_settings = JSON.parse(ss);
    _settings = {
      g_format: true
    };
    return g_settings = Object.assign(_settings, g_settings);
  })();

  format_number = g_settings.g_format ? g_format_number : a_format_number;
    ...
    class Game {
      constructor() {
        ...
        g_fmt_checkbox.addEventListener('click', (ev) => {
          format_number = ev.target.checked ? g_format_number : a_format_number;
          this.update_doms();
          this.cupcakes = this.cupcakes;
          return g_settings.g_format = ev.target.checked;
        });
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    window.addEventListener('beforeunload', function(ev) {
      if (has_localstorage) {
        game.browser_save();
        return localStorage.setItem('ccSettings', JSON.stringify(g_settings));
      } else {
        ev.preventDefault();
